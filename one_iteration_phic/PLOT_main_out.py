...
for i in range(5,50, 10 ):
    file = np.loadtxt(os.path.join('Analysed Outputs','GNU_'+particle+'_density_cloud_1keV_fs_t'+ str(i) +'.txt'))
    file[:,1] /= -1.0*spinteg.simps(file[:,1], file[:,0])
